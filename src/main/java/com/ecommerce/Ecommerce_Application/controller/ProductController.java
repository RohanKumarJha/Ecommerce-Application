...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> addProduct(@Valid @RequestBody ProductRequest productDTO,
        ...
        ProductResponse savedProductDTO = productService.addProduct(categoryId, productDTO);
    ...
    public ResponseEntity<ProductResponse> updateProduct(@Valid @RequestBody ProductRequest productDTO,
                                                    @PathVariable Long productId){
        ProductResponse updatedProductDTO = productService.updateProduct(productId, productDTO);
