package com.ecommerce.Ecommerce_Application.config;
...
import com.ecommerce.Ecommerce_Application.security.jwt.AuthEntryPointJwt;
import com.ecommerce.Ecommerce_Application.security.jwt.AuthTokenFilter;
...
//                .requestMatchers("/api/admin/**").permitAll()
    ...
    // ---------------------------------------
    // 8. Register Authentication Provider
    // ---------------------------------------
    private void configureAuthenticationProvider(HttpSecurity http) {
    ...
    // ---------------------------------------
    // 11. Ignore security from these request
    // ---------------------------------------
    @Bean
